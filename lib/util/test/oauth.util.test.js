...
describe('OAuth Util', function() {
  ...
  it(`should be able to get valid access token using client credential grant`, async () => {
    ...
    // TODO: this fails because the keycloak key response is dissimilar to azure key response
    // To fix this we need to conver the n and e values returned by keycloak to PEM cert format
