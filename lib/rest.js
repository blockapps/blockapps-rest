    ...
    return new Promise(function(resolve, reject) {
      ...
      return api.strato.last(0)
        .then(function(result) {
          ...
          verbose('getLastBlockNumber: #', block.blockData.number);
...
function waitNextBlock(node) {
  return function(scope) {
    ...
    function condition() {
      verbose('waitNextBlock: condition', previousBlockNumber, currentBlockNumber, (previousBlockNumber == currentBlockNumber));
