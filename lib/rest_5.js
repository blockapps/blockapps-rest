...
function* getChainInfo(chainId, node) {
  ...
  chainInfo.accountBalance.forEach(function(ab){
    balances.push({address: ab[0], balance: ab[1]});
  });
  
  return {
    label: chainInfo.chainLabel
  , addRule: chainInfo.addRule
  , removeRule: chainInfo.removeRule
  , members: chainInfo.members
  , balances: balances
  };
}
