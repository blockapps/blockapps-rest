 ...
 * @param{Object} options the optional arguments {value: Number, resolve: Boolean, chainId: Number, node: Number, enableHistory: Boolean, enableIndex: Boolean}
 * @returns{()} resolve=false: [transaction hash] (String), resolve=true: [method call return vals] (String|Int)
 */
...
function* call(user, contract, methodName, args, options={}) {
  ...
  var result = yield api.bloc.call({
    ...
    }, user.name, user.address, contract.name, contract.address, options.resolve, options.chainId, options.node)
    .catch(function(e) {
      throw (e instanceof Error) ? e : new HttpError(e);
    });
...
function* callList(user, txs, options={}) {
  ...
  const results = yield api.bloc.callList({
    ...
    }, user.name, user.address, options.resolve, options.chainId, options.node)
    .catch(function(e) {
      throw (e instanceof Error) ? e : new HttpError(e);
    });
  // verity results
  verifyListResult(txs, options.resolve, results);
 ...
 * @param{Object} options the optional arguments {resolve: Boolean, txParams: Object, chainId: Number, node: Number, enableHistory: Boolean, enableIndex: Boolean}
 * @returns{()} resolve=false: [transaction hash] (String), resolve=true: [uploaded contract details]
*/
 ...
 * @param{Object} options the optional arguments {resolve: Boolean, chainId: Number, node: Number, enableHistory: Boolean, enableIndex: Boolean}
 */
 ...
 * @param{Object} options the optional arguments {resolve: Boolean, chainId: Number, node: Number, enableHistory: Boolean, enableIndex: Boolean}
 * @returns{()} resolve=false: transaction hash (String), resolve=true: {status:String, hash:String, txResult:object, data: object}
*/
function* send(fromUser, toUser, value, options={}) {
  ...
  var result = yield api.bloc.send({
    ...
    }, fromUser.name, fromUser.address, options.resolve, options.chainId, options.node)
    .catch(function(e) {
      throw (e instanceof Error) ? e : new HttpError(e);
    });
...
function* getBlocResult(hash, options={}) {
  ...
  const result = yield api.bloc.result(hash, options.resolve, options.chainId, options.node)
    .catch(function(e) {
      throw (e instanceof Error) ? e : new HttpError(e);
    });
  return result;
...
function* sendTransactions(token, txs, options={}) {
  ...
  var results = yield api.strato23.sendTransactions({
      ...
      'Authorization': 'Bearer ' + token
    }, options.resolve, options.chainId)
    .catch(function(e) {
      throw (e instanceof Error) ? e : new HttpError(e);
    });
 ...
 * @param{String} toUser recepient
 * @param{Number} value amount to send in wei
 * @param{Object} options the optional arguments {resolve: Boolean, chainId: Number, nonce: Number, node: Number, enableHistory: Boolean, enableIndex: Boolean}
 * @returns{()} resolve=false: transaction hash (String), resolve=true: {status:String, hash:String, txResult:object, data: object}
 */
