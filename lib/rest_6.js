...
function* callList(user, txs, options={}) {
  verbose('callList', {user, txs, options, options.resolve});
...
function* uploadContractString(user, contractName, contractSrc, args, options={}) {
  ...
  verbose('uploadContractString', {user, contractName, args, options, options.resolve});
...
function *  uploadContractList(user, txs, options={}){
  verbose('uploadContractList', {user, txs, options, options.resolve})
...
function* send(fromUser, toUser, value, options={}) {
  verbose('send', {fromUser, toUser, value, options, options.resolve});
...
function* sendList(fromUser, txs, options={}) {
  verbose('sendList', {fromUser, txs, options, options.resolve});
...
function* callOAuth(token, contract, methodName, args, options={}) {
  ...
  const value = options.value || 0;
  const valueFixed = (value instanceof BigNumber) ? value.toFixed(0) : value;
  verbose('callOAuth', {token, contract, methodName, args, options, options.resolve});
...
function* sendOAuth(token, toUser, value, options={}) {
  verbose('sendOAuth', {token, toUser, value, options, options.resolve});
...
function* sendListOAuth(token, txs, options={}) {
  verbose('sendListOAuth', {token, txs, options, options.resolve});
...
function* callListOAuth(accessToken, txs, options={}) {
  verbose('callListOAuth', {accessToken, txs, options, options.resolve});
...
function* uploadContractStringOAuth(accessToken, contractName, contractSrc, args, options={}) {
  args = args || {};
  const txParams = options.txParams || {};
  verbose('uploadContractStringOAuth', {accessToken, contractName, args, options, options.resolve});
...
function *  uploadContractListOAuth(accessToken, txs, options={}){
  verbose('uploadContractListOAuth', {accessToken, txs, options, options.resolve})
